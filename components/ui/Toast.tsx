...
const Toast = ({message, status, type, ref}: ToastType & {ref?: RefObject<HTMLDivElement | null>}) => {
    ...
    return (
        <div ref={ref} className={"bg-background leading-[20px] h-[70px] hidden items-center gap-3 z-50 font-14-medium rounded-[5px] min-w-[300px] fixed right-[50%] translate-[50%] bottom-[120px] transition-opacity duration-300 ease-in"}>
